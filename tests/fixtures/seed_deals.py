...
SEED_DEALS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "deal_type": "opa_volontaire_parziale",
        "status": "withdrawn",
        "offer_price": None,
        "currency": "EUR",
    ...
    # ---- DE -----------------------------------------------------------
    {
        ...
        "deal_type": "freiwilliges_uebernahmeangebot",
        "status": "cleared",
    ...
    # ---- Cross-border (DE primary filing, FR/DE dual-listed target) ---
    {
        "juridiction": "DE",
        "secondary_jurisdictions": ["FR"],
