...
SAMPLE: list[dict[str, str | Decimal | None]] = [
    {"ref": "216C1735", "rel": "2022/216C1735.pdf", "target": "CEGID GROUP",
     "expected_price": Decimal("61.00"), "doc_type": "conformity_decision"},
    {"ref": "219C0051", "rel": "2022/219C0051.pdf", "target": "TESSI",
     "expected_price": Decimal("160.00"), "doc_type": "deposit_notice"},
    {"ref": "223C0044", "rel": "2023/223C0044.pdf", "target": "SERMA GROUP",
     "expected_price": None, "doc_type": "response_note_no_price"},
    {"ref": "224C0830", "rel": "2024/224C0830.pdf", "target": "TIPIAK",
     "expected_price": Decimal("88.00"), "doc_type": "deposit_notice"},
    {"ref": "224C0915", "rel": "2024/224C0915.pdf", "target": "TRAVEL TECHNOLOGY INTERACTIVE",
     "expected_price": Decimal("2.85"), "doc_type": "deposit_notice"},
    {"ref": "225C0021", "rel": "2026/225C0021.pdf", "target": "NEOEN",
     "expected_price": Decimal("39.85"), "doc_type": "deposit_notice"},
    {"ref": "225C0741", "rel": "2025/225C0741.pdf", "target": "FINANCIERE MONCEY",
     "expected_price": Decimal("133.00"), "doc_type": "conformity_decision_mixed"},
    {"ref": "225C0921", "rel": "2025/225C0921.pdf", "target": "M2I",
     "expected_price": Decimal("8.50"), "doc_type": "conformity_decision"},
    {"ref": "225C2081", "rel": "2025/225C2081.pdf", "target": "SOCIETE DE TAYNINH",
     "expected_price": Decimal("0.11"), "doc_type": "deposit_notice"},
    {"ref": "225C2156", "rel": "2026/225C2156.pdf", "target": "PRODWARE",
     "expected_price": Decimal("28.00"), "doc_type": "conformity_decision"},
]
...
def main() -> None:
    ...
    with OUT.open("w", encoding="utf-8", newline="") as fh:
        writer = csv.DictWriter(fh, fieldnames=["ref", "target", "doc_type",
